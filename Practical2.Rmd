...
- Implausible values (error?, missing?, outliers?)
...
More insights can be gained when looking at relationships between variables. This can be done in two main ways: using numerical representation of this association and visual representations.
