...
**Note:** The package `haven` is great to import from other statistical packages into R. But working with labelled variables is not very convenient (this is a personal opinion!) so I usually try to convert the variables back to the standard base-package R format, which is factors for categorical and numeric for continuos variables.
