...
```{r, echo=FALSE, fig.align= "center", out.width="300px", fig.cap="Credits: [Allison Horts](https://github.com/allisonhorst/stats-illustrations)", message=F, warning=F}
knitr::include_graphics("images/dragons_continuous.png")
```
...
The interpretation is similar to the SLR, the only difference here is the inclusion of a categorical variable "bcsvictimf". This variable has only two values, "yes" and "not" but the model will only print one which is called "reference category". Here we can see that the reference category is "victim of crime". This will tell you how much or less (depending on the sign) being a victim a crime affects the perception of the effectiveness of the CJS. 
...
```{r, echo=FALSE, fig.align= "center", out.width="300px", fig.cap="Credits: [Allison Horts](https://github.com/allisonhorst/stats-illustrations)", message=F, warning=F}
knitr::include_graphics("images/dragon_residual_distribution.png")
```
